...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // StatefulWidgetで実装
      body: const _ExpansionMessage(),

      // Riverpodで実装
      // body: const ExpansionMessageByRiverpod(),
    );
  }
}

class _ExpansionMessage extends StatefulWidget {
  const _ExpansionMessage();

  @override
  State<_ExpansionMessage> createState() => _ExpansionMessageState();
}

class _ExpansionMessageState extends State<_ExpansionMessage> {
  bool _show = false;
