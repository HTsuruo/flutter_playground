...
import 'package:flutter_playground/scroll_modal/sliding_sheet_sample_page.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const Divider(),
          ListTile(
            title: const Text('sliding_sheet'),
            onTap: () => Navigator.of(context).push<void>(MaterialPageRoute(
              builder: (context) => const SlidingSheetSamplePage(),
            )),
          ),
          const Divider(),
          ListTile(
